...
`),(({delay:t})=>t||0));function _t(){return _(jt,{children:[Q(Ft,{delay:"0s"}),Q(Ft,{delay:"0.3s"}),Q(Ft,{delay:"0.6s"})]})}const Qt=t=>{const e=new Date(t);e.setHours(e.getHours()+9);return`${e.getFullYear()}년 ${e.getMonth()+1}월 ${e.getDay()}일`},Dt="https://dev.to",qt="dango0812",It="fDwtyzQ7BU8gb9MEjzt3CB4a"}}}))}();
